...
describe("notifyAdmin", () => {
  // D-35: base send-to-admin-space primitive — same "Mercury reasons, never
  // a blind template" delivery mechanism as D-25 for owned findings, just a
  // direct call here since this specific message (identity bridge fallback)
  // is a deterministic system notice, not a personalized per-user finding.
